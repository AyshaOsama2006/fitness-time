        ...
        {mealResult?.length > 0 ? (
          mealResult.map((meal, i) => (
            <div key={i} className="meal-item mb-3 p-3 border rounded">
              ...
              <p className="small">{Array.isArray(meal.ingredients) ? meal.ingredients.join(', ') : meal.ingredients}</p>
              <div>
                <span className="badge bg-primary me-1">PROTEIN: {meal.protein}g</span>
                <span className="badge bg-warning me-1">CARBS: {meal.carbohydrates}g</span>
                <span className="badge bg-success">FAT: {meal.fat}g</span>
              </div>
            </div>
          ))
        ) : (
        ...
        {calorieResult ? (
          <>
            <div className="calorie-circle mb-4">
              <div className="number">{calorieResult.estimatedCalories}</div>
              <div>KCAL</div>
            </div>
            <div className="row g-2">
              <div className="col-4"><div className="stat blue">P: {calorieResult.protein}g</div></div>
              <div className="col-4"><div className="stat yellow">K: {calorieResult.carbohydrates}g</div></div>
      ...
      {personalResult ? (
        <>
          <div className="text-center mb-4">
            <div className="display-4 text-danger">{personalResult.dailyCalories}</div>
          ...
          <div className="macros-list">
            ...
            <div className="macro-item">
              <span>CARBS</span>
              <strong>{personalResult.carbohydrates}g</strong>
            </div>
            <div className="macro-item">
              <span>FATS</span>
