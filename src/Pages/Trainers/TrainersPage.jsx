...
function TrainersPage() {
  ...
  const extraData = {
    "Marcus Johnson": {
      ...
      description:
        "Former competitive bodybuilder with expertise in strength training and athletic performance optimization",
      experience: "10+ years",
      clients: "250+ Clients",
      skills: [
        "Weight Training",
    ...
    "Sophia Lee": {
      ...
      description:
        "Certified yoga instructor helping clients improve flexibility and mental wellness",
      experience: "8+ years",
      clients: "180+ Clients",
    ...
    "David Kim": {
      ...
      description:
        "Focused on customized workout plans for all fitness levels",
      experience: "12+ years",
      clients: "300+ Clients",
    ...
    "Emma Watson": {
      specialty: "Pilates",
      description:
        "Expert in Pilates for core strength and posture correction",
      experience: "9+ years",
      clients: "200+ Clients",
      skills: [
        "Pilates",
    ...
    "John Doe": {
      ...
      description:
        "High-Intensity Interval Training specialist to burn fat fast",
      experience: "7+ years",
      clients: "220+ Clients",
    ...
    "Linda Smith": {
      ...
      description:
        "Helps clients balance diet and lifestyle for optimal health",
      experience: "10+ years",
      clients: "190+ Clients",
      skills: [
        "Nutrition",
  ...
  return (
    ...
    >
      <h1 className="text-center text-danger mb-3">
        OUR TRAINERS
      </h1>
